...
class RadialOcclusionView {
    ...
    setupGradientQuadSceneObject(sceneObjectName) {
        (0, validate_1.validate)(this.handVisuals?.middleKnuckle);
    ...
    updateGradientScaleFactor() {
        (0, validate_1.validate)(this.handVisuals?.indexTip);
        (0, validate_1.validate)(this.handVisuals?.indexTip);
        (0, validate_1.validate)(this.handVisuals?.middleTip);
        (0, validate_1.validate)(this.handVisuals?.ringTip);
