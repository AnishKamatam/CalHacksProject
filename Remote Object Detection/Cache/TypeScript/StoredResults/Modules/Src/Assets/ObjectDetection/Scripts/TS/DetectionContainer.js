...
let DetectionContainer = (() => {
    ...
    var DetectionContainer = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.categoryAndConfidence = this.categoryAndConfidence;
            this.distanceFromCamera = this.distanceFromCamera;
            this.polyline = this.polyline;
            this.billboard = this.billboard;
            this.polylinePoints = this.polylinePoints;
        }
        __initialize() {
            super.__initialize();
            this.categoryAndConfidence = this.categoryAndConfidence;
    ...
    __setFunctionName(_classThis, "DetectionContainer");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        DetectionContainer = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DetectionContainer = _classThis;
})();
