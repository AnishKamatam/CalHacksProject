...
class RaycastAnchorHead extends RaycastBase_1.default {
    ...
    getRay() {
        ...
        const irInteractionXRotationInRadians = this.irInteractionTransitionStrategy?.computeXRotationInRadians(this.determineGazePitchInRadians(data), toWorldFromSituationSpace, filteredLocus) ?? 0;
