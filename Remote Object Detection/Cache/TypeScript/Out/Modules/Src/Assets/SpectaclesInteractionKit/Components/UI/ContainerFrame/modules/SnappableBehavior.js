...
class SnappableBehavior {
    ...
    constructor(options) {
        ...
        this.frameTransform = this.frame
            .getFrameObject()
            ?.getTransform();
        ...
        this.onTriggerRelease = (e) => {
            ...
            if (this.isActive && !this.isScaling && this.isEnabled) {
                ...
                if (this.snapTo &&
                    ...
                    let startPosition = this.parentTransform?.getLocalPosition() || vec3.zero();
                    (0, animate_1.default)({
                    ...
                    let startRot = this.parentTransform?.getWorldRotation() || quat.quatIdentity();
